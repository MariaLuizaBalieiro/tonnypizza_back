    ...
    arrayPizza.forEach(function(produto){
        if(produto.id == idProduto){
            ...
            arrayComentarios.forEach(function(comen){
                const imgUsuario = comen.usuario.imgUsuario
                const nomeUsuario = comen.usuario.nome
                let jsonC = {}
    
               jsonC.imgU = imgUsuario
...
const mostrarSobremesas = (idProdutos) => {
    const arrayBebida = produtos.sobremesas
